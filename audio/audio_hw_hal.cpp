...
#define LOG_TAG "atmel_audio_hw_hal"
//#define LOG_NDEBUG 0
...
struct atmel_audio_module {
    struct audio_module module;
};

struct atmel_audio_device {
    struct audio_hw_device device;

    struct AudioHardwareInterface *hwif;
};

struct atmel_stream_out {
    struct audio_stream_out stream;

    AudioStreamOut *atmel_out;
};

struct atmel_stream_in {
    struct audio_stream_in stream;

    AudioStreamIn *atmel_in;
};
...
{
    const struct atmel_stream_out *out =
        reinterpret_cast<const struct atmel_stream_out *>(stream);
    return out->atmel_out->sampleRate();
}

static int out_set_sample_rate(struct audio_stream *stream, uint32_t rate)
{
    struct atmel_stream_out *out =
        reinterpret_cast<struct atmel_stream_out *>(stream);
...
static size_t out_get_buffer_size(const struct audio_stream *stream)
{
    const struct atmel_stream_out *out =
        reinterpret_cast<const struct atmel_stream_out *>(stream);
    return out->atmel_out->bufferSize();
}
...
static audio_channel_mask_t out_get_channels(const struct audio_stream *stream)
{
    const struct atmel_stream_out *out =
        reinterpret_cast<const struct atmel_stream_out *>(stream);
    return (audio_channel_mask_t) out->atmel_out->channels();
}
...
static audio_format_t out_get_format(const struct audio_stream *stream)
{
    ...
    return (audio_format_t) out->atmel_out->format();
}
...
static int out_dump(const struct audio_stream *stream, int fd)
{
    ...
    return out->atmel_out->dump(fd, args);
}
...
static int out_set_parameters(struct audio_stream *stream, const char *kvpairs)
{
    ...
    return out->atmel_out->setParameters(s8);
}
...
static char * out_get_parameters(const struct audio_stream *stream, const char *keys)
{
    ...
    s8 = out->atmel_out->getParameters(String8(keys));
                          ...
                          float right)
{
    struct atmel_stream_out *out =
        reinterpret_cast<struct atmel_stream_out *>(stream);
    return out->atmel_out->setVolume(left, right);
}
                         ...
                         size_t bytes)
{
    struct atmel_stream_out *out =
        reinterpret_cast<struct atmel_stream_out *>(stream);
    return out->atmel_out->write(buffer, bytes);
}
                                   ...
                                   uint32_t *dsp_frames)
{
    const struct atmel_stream_out *out =
        reinterpret_cast<const struct atmel_stream_out *>(stream);
    return out->atmel_out->getRenderPosition(dsp_frames);
}
                                        ...
                                        int64_t *timestamp)
{
    const struct atmel_stream_out *out =
        reinterpret_cast<const struct atmel_stream_out *>(stream);
    return out->atmel_out->getNextWriteTimestamp(timestamp);
}
...
{
    const struct atmel_stream_in *in =
        reinterpret_cast<const struct atmel_stream_in *>(stream);
    return in->atmel_in->sampleRate();
}

static int in_set_sample_rate(struct audio_stream *stream, uint32_t rate)
{
    struct atmel_stream_in *in =
        reinterpret_cast<struct atmel_stream_in *>(stream);
...
static audio_channel_mask_t in_get_channels(const struct audio_stream *stream)
{
    const struct atmel_stream_in *in =
        reinterpret_cast<const struct atmel_stream_in *>(stream);
    return (audio_channel_mask_t) in->atmel_in->channels();
}
...
static audio_format_t in_get_format(const struct audio_stream *stream)
{
    const struct atmel_stream_in *in =
        reinterpret_cast<const struct atmel_stream_in *>(stream);
    // legacy API, don't change return type
    return (audio_format_t) in->atmel_in->format();
}
...
{
    struct atmel_stream_in *in = reinterpret_cast<struct atmel_stream_in *>(stream);
    return in->atmel_in->standby();
}
...
static int in_dump(const struct audio_stream *stream, int fd)
{
    const struct atmel_stream_in *in =
        reinterpret_cast<const struct atmel_stream_in *>(stream);
    Vector<String16> args;
    return in->atmel_in->dump(fd, args);
}
...
static int in_set_parameters(struct audio_stream *stream, const char *kvpairs)
{
    ...
    return in->atmel_in->setParameters(s8);
}
                                ...
                                const char *keys)
{
    ...
    s8 = in->atmel_in->getParameters(String8(keys));
...
static int in_set_gain(struct audio_stream_in *stream, float gain)
{
    struct atmel_stream_in *in =
        reinterpret_cast<struct atmel_stream_in *>(stream);
    return in->atmel_in->setGain(gain);
}
                       ...
                       size_t bytes)
{
    struct atmel_stream_in *in =
        reinterpret_cast<struct atmel_stream_in *>(stream);
    return in->atmel_in->read(buffer, bytes);
}
...
static uint32_t in_get_input_frames_lost(struct audio_stream_in *stream)
{
    struct atmel_stream_in *in =
        reinterpret_cast<struct atmel_stream_in *>(stream);
    return in->atmel_in->getInputFramesLost();
}
...
static int in_add_audio_effect(const struct audio_stream *stream, effect_handle_t effect)
{
    const struct atmel_stream_in *in =
        reinterpret_cast<const struct atmel_stream_in *>(stream);
    return in->atmel_in->addAudioEffect(effect);
}
...
static int in_remove_audio_effect(const struct audio_stream *stream, effect_handle_t effect)
{
    const struct atmel_stream_in *in =
        reinterpret_cast<const struct atmel_stream_in *>(stream);
    return in->atmel_in->removeAudioEffect(effect);
}

/** audio_hw_device implementation **/
static inline struct atmel_audio_device * to_ladev(struct audio_hw_device *dev)
{
    return reinterpret_cast<struct atmel_audio_device *>(dev);
}

static inline const struct atmel_audio_device * to_cladev(const struct audio_hw_device *dev)
{
    return reinterpret_cast<const struct atmel_audio_device *>(dev);
}

static int adev_init_check(const struct audio_hw_device *dev)
{
    const struct atmel_audio_device *ladev = to_cladev(dev);
...
{
    struct atmel_audio_device *ladev = to_ladev(dev);
                                   ...
                                   struct audio_stream_out **stream_out)
{
    ...
    out = (struct atmel_stream_out *)calloc(1, sizeof(*out));
    if (!out)
        return -ENOMEM;

    devices = convert_audio_device(devices, HAL_API_REV_2_0, HAL_API_REV_1_0);

    out->atmel_out = ladev->hwif->openOutputStream(devices, (int *) &config->format,
                                                    &config->channel_mask,
...
{
    struct atmel_audio_device *ladev = to_ladev(dev);
    struct atmel_stream_out *out = reinterpret_cast<struct atmel_stream_out *>(stream);

    ladev->hwif->closeOutputStream(out->atmel_out);
    free(out);
}
                                  ...
                                  struct audio_stream_in **stream_in)
{
    ...
    in = (struct atmel_stream_in *)calloc(1, sizeof(*in));
    if (!in)
        return -ENOMEM;

    devices = convert_audio_device(devices, HAL_API_REV_2_0, HAL_API_REV_1_0);

    in->atmel_in = ladev->hwif->openInputStream(devices, (int *) &config->format,
                               ...
                               struct audio_stream_in *stream)
{
    ...
    ladev->hwif->closeInputStream(in->atmel_in);
    free(in);
}
...
static int atmel_adev_close(hw_device_t* device)
{
    struct audio_hw_device *hwdev =
                        reinterpret_cast<struct audio_hw_device *>(device);
    struct atmel_audio_device *ladev = to_ladev(hwdev);
...
static int atmel_adev_open(const hw_module_t* module, const char* name,
                            hw_device_t** device)
{
    struct atmel_audio_device *ladev;
    int ret;

    if (strcmp(name, AUDIO_HARDWARE_INTERFACE) != 0)
        return -EINVAL;

    ladev = (struct atmel_audio_device *)calloc(1, sizeof(*ladev));
    if (!ladev)
        return -ENOMEM;
    ...
    ladev->device.common.close = atmel_adev_close;
...
static struct hw_module_methods_t atmel_audio_module_methods = {
        open: atmel_adev_open
};

struct atmel_audio_module HAL_MODULE_INFO_SYM = {
    module: {
        common: {
            ...
            name: "ATMEL Audio HW HAL",
            author: "The Android Open Source Project",
            methods: &atmel_audio_module_methods,
            dso : NULL,
            reserved : {0},
        },
    },
