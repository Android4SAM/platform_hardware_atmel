 ...
 */
class SamCameraProtocol1 : public camera_device, public SamCameraBase {
public:
     ...
     */
    SamCameraProtocol1(int cameraId,
                   struct hw_module_t* module);

    /* Destructs EmulatedCamera instance. */
    virtual ~SamCameraProtocol1();
...
public:
     ...
     */
    virtual SamSensorBase* getCameraDevice() = 0;
