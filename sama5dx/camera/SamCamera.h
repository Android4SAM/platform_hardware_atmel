 ...
 */
class SamCamera : public SamCameraProtocol1 {
public:
    /* Constructs SamCamera instance. */
    SamCamera(int cameraId, bool facingBack, struct hw_module_t* module);

    /* Destructs SamCamera instance. */
    ~SamCamera();
...
public:
    /* Initializes SamCamera instance. */
     status_t Initialize();

    /****************************************************************************
     * SamCamera abstract API implementation.
     ***************************************************************************/

protected:
    /* Gets emulated camera device ised by this instance of the emulated camera.
     */
    SamSensorBase* getCameraDevice();
...
protected:
    ...
    /* Contained Sam camera device object. */
    SamSensor    mSamSensor;
};
