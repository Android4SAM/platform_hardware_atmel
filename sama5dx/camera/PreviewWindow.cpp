...
//#define LOG_NDEBUG 0
#define LOG_TAG "SamCamera_PreviewWindow"
                                         ...
                                         SamSensorBase* camera_dev)
{
    ...
    memcpy(img, frame, camera_dev->getFrameBufferSize());
    if (res == NO_ERROR) {
        /* Show it. */
...
bool PreviewWindow::adjustPreviewDimensions(SamSensorBase* camera_dev)
{
