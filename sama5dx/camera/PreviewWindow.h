...
public:
    ...
    /*Get the count of frames which has been displayed*/
    inline uint64_t getPreviewFrameCount()
    {
...
protected:
     ...
     */
    bool adjustPreviewDimensions(SamSensorBase* camera_dev);
...
protected:
    ...
    /* Frames has been displayed.*/
    uint64_t                        mPreviewFrameCount;
