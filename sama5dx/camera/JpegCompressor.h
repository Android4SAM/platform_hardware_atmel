...
/*
 * Contains declaration of a class NV21JpegCompressor and 422IJpegCompressor
 * that encapsulates a converter between YV21, Yuv422I and JPEG formats.
 */
...
/* Encapsulates a converter between YV12, Yuv422I, and JPEG formats.
 */
class JpegCompressor
{
public:
    /* Constructs JpegCompressor instance. */
    JpegCompressor(int format);
...
public:
    /* Compresses raw image into a JPEG.
